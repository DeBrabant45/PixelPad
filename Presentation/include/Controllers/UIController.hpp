...
namespace PixelPad::Presentation
{
	...
	private:
		...
		PixelPad::Infrastructure::EventBus::SubscriptionToken m_buttonClickedColorEventToken;
		PixelPad::Infrastructure::EventBus::SubscriptionToken m_buttonClickedToolTypeEventToken;
	};
}